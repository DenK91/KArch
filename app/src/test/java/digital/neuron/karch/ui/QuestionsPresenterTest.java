package digital.neuron.karch.ui;
...
import digital.neuron.karch.ui.questions.QuestionsContract;
import digital.neuron.karch.ui.questions.QuestionsPresenter;
...
public class QuestionsPresenterTest {
    ...
    @Test
    public void loadQuestions_ShouldAlwaysStopLoadingIndicatorOnView_WhenComplete() {
        // Given
    ...
    public void loadQuestions_ShouldShowMessage_WhenNoDataReturned() {
        ...
        // Then
        then(view).should().clearQuestions();
        then(view).should(never()).showQuestions(ArgumentMatchers.<Question>anyList());
    ...
    @Test
    public void search_EmptyMessageShouldBeShownOnView_WhenDataIsEmpty() {
        // Given
        given(repository.loadQuestions(false)).willReturn(Flowable.just(NO_QUESTION));

        // When
        presenter.search(Mockito.anyString());
        testScheduler.triggerActions();
    ...
    @Test
    public void search_EmptyMessageShouldBeShownOnView_WhenNoDataMatchesQuery() {
        // Given
        QUESTION1.setTitle("activity onCreate");
        QUESTION2.setTitle("activity onDestroy");
        QUESTION3.setTitle("fragment");
